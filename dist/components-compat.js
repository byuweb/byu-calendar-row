...
(function () {
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ":host{padding:10px 0;border-bottom:1px solid #e5e5e5;margin-bottom:10px}.section-first{background:#e5e5e5;color:#002e5d}.section-second{padding:15px;color:#767676}:host .content{width:100%;display:flex;justify-content:center}:host .content,:host ::slotted(*){font-family:Gotham A,Gotham B}#title ::slotted(*){color:#002e5d!important;font-size:24px;font-weight:700;text-decoration:none}#location ::slotted(*){font-size:14px;text-transform:uppercase}#price ::slotted(*){font-weight:700;color:#4d8501}#time ::slotted(*){font-size:14px;text-transform:uppercase}#tickets-link ::slotted(*){text-align:center;background-color:#4d8501;padding:9px 15px;width:120px;font-size:12px;color:#fff;text-decoration:none}#tickets-link ::slotted(*):before{content:\"Price: \"}.section-second{min-height:100px;padding:0 15px 15px;display:block;width:100%;max-width:654px}#title ::slotted(*){line-height:1.2}#weekday{text-transform:uppercase;font-size:14px;padding-bottom:10px}#location ::slotted(*){color:#767676;font-size:12px;font-weight:500}#date,#date ::slotted(*){display:none}.section-third{padding-top:8px;width:250px}:host([type=tile]){display:flex;flex-wrap:wrap;justify-content:flex-start;margin:10px 8px}:host([type=tile]) .section-first{height:120px;width:120px;display:block;flex-wrap:wrap;justify-content:center;background:#e5e5e5;margin-bottom:15px}:host([type=tile]) .section-second ::slotted(*){justify-content:flex-start}:host([type=tile]) #month-name{padding:10px;font-size:13px;text-transform:uppercase;margin-bottom:0;font-weight:500}:host([type=tile]) #day-number{font-size:48px;margin-bottom:5px;font-weight:700}:host([type=tile]) #title ::slotted(*){color:#002e5d!important;font-size:18px;font-weight:700;text-align:center;padding:0 0 5px}:host([type=tile]) #time ::slotted(*){font-size:14px}:host([type=tile]) #location ::slotted(*){color:#767676;text-align:center;font-weight:500;padding:4px 0}:host([type=tile]) #link ::slotted(*){color:#002e5d;text-decoration:none}:host([type=image]){width:420px;margin:10px 15px;display:flex}:host([type=image]) .section-first{width:120px;min-height:120px!important}:host([type=image]) .section-second ::slotted(*){width:290px}:host([type=image]).extra-wide .section-second ::slotted(*){width:360px}:host([type=image]) #month-abb{padding:10px 0;font-size:22px;text-transform:uppercase;margin-bottom:0}:host([type=image]) #day-number{font-size:48px;font-weight:700}:host([type=image]) #time{padding:10px 0}:host([type=image]) #time ::slotted(*){color:#fff;padding:5px 0 10px;display:flex;justify-content:center}:host([type=image]) #title ::slotted(*){padding:5px 0 10px;width:100%;overflow:hidden}:host([type=image]) #location ::slotted(*){padding-top:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis!important}.section-second ::slotted(*){color:#767676;padding:0;margin:0;display:flex;flex-wrap:wrap;width:100%}:host ::slotted(img){display:none}a,div,p{font-family:Gotham A,Gotham B}h1,h2,h3,h4{font-family:Sentinel A,Sentinel B}", ""]);
